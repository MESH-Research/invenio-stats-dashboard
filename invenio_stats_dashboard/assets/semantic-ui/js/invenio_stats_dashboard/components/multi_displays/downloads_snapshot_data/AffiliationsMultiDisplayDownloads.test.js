...
import { AffiliationsMultiDisplayDownloads } from './AffiliationsMultiDisplayDownloads';
...
describe('AffiliationsMultiDisplayDownloads', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<AffiliationsMultiDisplayDownloads default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<AffiliationsMultiDisplayDownloads title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
