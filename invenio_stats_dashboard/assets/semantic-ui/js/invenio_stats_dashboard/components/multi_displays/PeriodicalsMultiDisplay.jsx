...
const PeriodicalsMultiDisplay = ({
  ...
  const periodicalsData = seriesCategoryMap[recordStartBasis]?.periodicals?.records;
  const rawPeriodicals = filterSeriesArrayByDate(periodicalsData, dateRange, true);
