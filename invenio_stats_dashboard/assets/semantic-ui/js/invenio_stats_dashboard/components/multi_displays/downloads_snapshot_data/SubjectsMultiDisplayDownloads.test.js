...
import { SubjectsMultiDisplayDownloads } from './SubjectsMultiDisplayDownloads';
...
describe('SubjectsMultiDisplayDownloads', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<SubjectsMultiDisplayDownloads default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<SubjectsMultiDisplayDownloads title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
