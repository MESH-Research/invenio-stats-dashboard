...
const SubjectsMultiDisplayViewsDelta = ({
  title = i18next.t("Subjects"),
  icon: labelIcon = "tag",
  pageSize = 10,
  headers = [i18next.t("Subject"), i18next.t("Views")],
  default_view = "pie",
...
SubjectsMultiDisplayViewsDelta.propTypes = {
...
export { SubjectsMultiDisplayViewsDelta };
