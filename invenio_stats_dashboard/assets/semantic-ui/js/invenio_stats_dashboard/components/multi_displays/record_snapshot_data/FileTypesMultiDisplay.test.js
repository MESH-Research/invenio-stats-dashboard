...
describe("FileTypesMultiDisplay", () => {
	...
	describe("transformMultiDisplayData (helper function)", () => {
		...
		it("should create correct links for each file type", () => {
			...
			expect(result.transformedData[0].link).toContain(
				"/search?q=&f=file_type:pdf",
			);
		});

		it("should create correct links for community searches", () => {
			const mockData = [
				{
					id: "pdf",
					name: "PDF",
			...
			expect(result.transformedData[0].link).toContain(
				"https://invenio.org/communities/test-community/records?q=&f=file_type:pdf",
			);
		});
		...
		it("should create otherData with all expected properties when there are additional items", () => {
			const mockData = [
				{ id: "pdf", name: "PDF", year: 2024, data: [["01-01", 100]] },
				{ id: "csv", name: "CSV", year: 2024, data: [["01-01", 50]] },
				{ id: "txt", name: "Text", year: 2024, data: [["01-01", 25]] },
			];
		...
		it("should handle zero total count", () => {
			const mockData = [
				{ id: "pdf", name: "PDF", year: 2024, data: [["01-01", 0]] },
				{ id: "csv", name: "CSV", year: 2024, data: [["01-01", 0]] },
			];
			...
			const transformedData = [
				{
					...
					value: 100,
					percentage: 67,
					link: "/search?q=files.entries.ext:pdf",
				},
				{
					id: "csv",
					name: "CSV",
					value: 50,
					percentage: 33,
					link: "/search?q=files.entries.ext:csv",
				},
			];
	...
	describe("Component rendering with different display types", () => {
		...
		it("should render with custom headers properly", async () => {
			...
			render(
				<FileTypesMultiDisplay headers={customHeaders} default_view="list" />,
			);
