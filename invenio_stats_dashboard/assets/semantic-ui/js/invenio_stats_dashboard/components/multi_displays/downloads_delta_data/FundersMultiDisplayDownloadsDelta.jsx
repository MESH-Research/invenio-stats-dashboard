...
const FundersMultiDisplayDownloadsDelta = ({
  title = i18next.t("Funders"),
  icon: labelIcon = "money bill alternate",
  pageSize = 10,
  headers = [i18next.t("Funder"), i18next.t("Downloads")],
  default_view = "pie",
...
FundersMultiDisplayDownloadsDelta.propTypes = {
...
export { FundersMultiDisplayDownloadsDelta };
