...
describe('TopLanguagesMultiDisplay', () => {
  ...
  describe('transformMultiDisplayData (helper function)', () => {
    it('should return empty data when input is null', () => {
      const result = transformMultiDisplayData(null, 10, 'metadata.language.id');
    ...
    it('should return empty data when input is undefined', () => {
      const result = transformMultiDisplayData(undefined, 10, 'metadata.language.id');
    ...
    it('should return empty data when input is not an array', () => {
      const result = transformMultiDisplayData('not an array', 10, 'metadata.language.id');
    ...
    it('should transform valid languages data correctly', () => {
      ...
      const result = transformMultiDisplayData(mockData, 2, 'metadata.language.id');
    ...
    it('should handle data with missing or invalid values', () => {
      ...
      const result = transformMultiDisplayData(mockData, 10, 'metadata.language.id');
  ...
  describe('filterSeriesArrayByDate integration', () => {
    ...
    it('should work with the actual component data flow', () => {
      ...
      const result = transformMultiDisplayData(filteredData, 10, 'metadata.language.id');
