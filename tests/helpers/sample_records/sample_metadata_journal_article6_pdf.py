...
sample_metadata_journal_article6_pdf = {
    ...
    "metadata": {
        ...
        "title": (
            "Trends and Concerns in Library Services for Incarcerated People "
            "and People in the Process of Reentry: Publication Review "
            "(2020-2022)"
        ),
        ...
        "description": (
            "This is a white paper reviewing publications from 2020-2022 that "
            "relate to library and information services for people who are "
            "incarcerated or in the process of reentry. It covers a variety of "
            "library types, forms of outreach, services to specific demographics, "
    ...
    "files": {
        ...
        "entries": {
            ...
            "(2020-2022)-1.pdf": {
                ...
                "key": (
                    "Trends and Concerns in Library Services for Incarcerated "
                    "People and People in the Process of Reentry Publication "
                    "Review (2020-2022)-1.pdf"
                ),
                "access": {"hidden": False},
            }
        },
