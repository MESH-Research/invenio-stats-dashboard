...
const ResourceTypesMultiDisplayDownloadsDelta = ({
  title = i18next.t("Resource Types"),
  icon: labelIcon = "file",
  pageSize = 10,
  headers = [i18next.t("Work Type"), i18next.t("Downloads")],
  default_view = "pie",
...
ResourceTypesMultiDisplayDownloadsDelta.propTypes = {
...
export { ResourceTypesMultiDisplayDownloadsDelta };
