...
const SubjectsMultiDisplayDownloadsDelta = ({
	title = i18next.t("Subjects"),
	icon: labelIcon = "tag",
	pageSize = 10,
	headers = [i18next.t("Subject"), i18next.t("Downloads")],
	default_view = "pie",
...
SubjectsMultiDisplayDownloadsDelta.propTypes = {
...
export { SubjectsMultiDisplayDownloadsDelta };
