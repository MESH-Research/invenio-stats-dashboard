...
import { RightsMultiDisplayDownloadsDelta } from './RightsMultiDisplayDownloadsDelta';
...
describe('RightsMultiDisplayDownloadsDelta', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<RightsMultiDisplayDownloadsDelta default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<RightsMultiDisplayDownloadsDelta title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
