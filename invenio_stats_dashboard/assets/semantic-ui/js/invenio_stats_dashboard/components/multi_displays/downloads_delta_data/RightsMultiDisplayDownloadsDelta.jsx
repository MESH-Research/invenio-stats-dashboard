...
const RightsMultiDisplayDownloadsDelta = ({
	title = i18next.t("Rights"),
	icon: labelIcon = "copyright",
	pageSize = 10,
	headers = [i18next.t("Rights"), i18next.t("Downloads")],
	default_view = "pie",
...
RightsMultiDisplayDownloadsDelta.propTypes = {
...
export { RightsMultiDisplayDownloadsDelta };
