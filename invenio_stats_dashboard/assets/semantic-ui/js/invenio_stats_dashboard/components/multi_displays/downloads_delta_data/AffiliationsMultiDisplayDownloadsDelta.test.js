...
import { AffiliationsMultiDisplayDownloadsDelta } from './AffiliationsMultiDisplayDownloadsDelta';
...
describe('AffiliationsMultiDisplayDownloadsDelta', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<AffiliationsMultiDisplayDownloadsDelta default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<AffiliationsMultiDisplayDownloadsDelta title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
