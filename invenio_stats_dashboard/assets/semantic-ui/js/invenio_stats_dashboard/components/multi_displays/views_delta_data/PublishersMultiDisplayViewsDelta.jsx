...
const PublishersMultiDisplayViewsDelta = ({
  title = i18next.t("Publishers"),
  icon: labelIcon = "building",
  pageSize = 10,
  headers = [i18next.t("Publisher"), i18next.t("Views")],
  default_view = "pie",
...
PublishersMultiDisplayViewsDelta.propTypes = {
...
export { PublishersMultiDisplayViewsDelta };
