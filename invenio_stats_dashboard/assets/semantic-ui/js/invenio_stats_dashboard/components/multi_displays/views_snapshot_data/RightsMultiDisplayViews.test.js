...
import { RightsMultiDisplayViews } from './RightsMultiDisplayViews';
...
describe('RightsMultiDisplayViews', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<RightsMultiDisplayViews default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<RightsMultiDisplayViews title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
