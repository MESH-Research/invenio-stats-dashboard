  ...
  const transformedData = [
    {
      ...
      data:
        filterByDateRange(stats.recordCount, dateRange)?.map((point) => [
          point.date,
          point.value,
          point.resourceTypes,
    ...
    },
    {
      ...
      data:
        filterByDateRange(stats.uploaders, dateRange)?.map((point) => [
          point.date,
          point.value,
          point.resourceTypes,
          point.subjectHeadings,
    ...
    {
      name: i18next.t("Updoaded Data"),
      data:
        filterByDateRange(stats.dataVolume, dateRange)?.map((point) => [
          point.date,
          point.value,
          point.resourceTypes,
          point.subjectHeadings,
