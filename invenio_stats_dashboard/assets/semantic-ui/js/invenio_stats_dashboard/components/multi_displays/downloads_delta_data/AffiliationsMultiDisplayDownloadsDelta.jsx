...
const AffiliationsMultiDisplayDownloadsDelta = ({
	title = i18next.t("Affiliations"),
	icon: labelIcon = "university",
	pageSize = 10,
	headers = [i18next.t("Affiliation"), i18next.t("Downloads")],
	default_view = "pie",
...
AffiliationsMultiDisplayDownloadsDelta.propTypes = {
...
export { AffiliationsMultiDisplayDownloadsDelta };
