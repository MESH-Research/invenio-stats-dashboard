...
import { FundersMultiDisplayDownloadsDelta } from './FundersMultiDisplayDownloadsDelta';
...
describe('FundersMultiDisplayDownloadsDelta', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<FundersMultiDisplayDownloadsDelta default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<FundersMultiDisplayDownloadsDelta title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
