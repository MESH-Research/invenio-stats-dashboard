...
import { PublishersMultiDisplayViews } from './PublishersMultiDisplayViews';
...
describe('PublishersMultiDisplayViews', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<PublishersMultiDisplayViews default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<PublishersMultiDisplayViews title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
