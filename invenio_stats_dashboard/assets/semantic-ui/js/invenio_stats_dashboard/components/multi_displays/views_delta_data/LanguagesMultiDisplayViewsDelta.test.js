...
import { LanguagesMultiDisplayViewsDelta } from './LanguagesMultiDisplayViewsDelta';
...
describe('LanguagesMultiDisplayViewsDelta', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<LanguagesMultiDisplayViewsDelta default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<LanguagesMultiDisplayViewsDelta title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
