...
const LanguagesMultiDisplayViewsDelta = ({
	title = i18next.t("Languages"),
	icon: labelIcon = "language",
	pageSize = 10,
	headers = [i18next.t("Language"), i18next.t("Views")],
	default_view = "pie",
...
LanguagesMultiDisplayViewsDelta.propTypes = {
...
export { LanguagesMultiDisplayViewsDelta };
