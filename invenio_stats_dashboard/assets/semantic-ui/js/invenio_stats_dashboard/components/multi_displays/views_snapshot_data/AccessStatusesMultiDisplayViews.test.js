...
import { AccessStatusesMultiDisplayViews } from './AccessStatusesMultiDisplayViews';
...
describe('AccessStatusesMultiDisplayViews', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<AccessStatusesMultiDisplayViews default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<AccessStatusesMultiDisplayViews title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
