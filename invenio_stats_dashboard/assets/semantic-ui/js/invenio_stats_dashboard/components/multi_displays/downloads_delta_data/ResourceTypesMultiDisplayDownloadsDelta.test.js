...
import { ResourceTypesMultiDisplayDownloadsDelta } from './ResourceTypesMultiDisplayDownloadsDelta';
...
describe('ResourceTypesMultiDisplayDownloadsDelta', () => {
  ...
  describe('Component rendering', () => {
    ...
    it('should render with custom title and headers', () => {
      render(<ResourceTypesMultiDisplayDownloadsDelta title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
