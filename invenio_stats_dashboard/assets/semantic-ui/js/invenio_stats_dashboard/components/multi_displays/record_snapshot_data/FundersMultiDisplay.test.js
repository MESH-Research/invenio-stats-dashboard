...
describe('FundersMultiDisplay', () => {
  ...
  describe('transformMultiDisplayData (helper function)', () => {
    it('should return empty data when input is null', () => {
      const result = transformMultiDisplayData(null, null, 10, 'metadata.funding.funder');
    ...
    it('should return empty data when input is undefined', () => {
      const result = transformMultiDisplayData(undefined, null, 10, 'metadata.funding.funder');
    ...
    it('should return empty data when input is not an array', () => {
      const result = transformMultiDisplayData('not an array', null, 10, 'metadata.funding.funder');
    ...
    it('should transform valid funders data correctly', () => {
      ...
      const result = transformMultiDisplayData(mockData, null, 2, 'metadata.funding.funder');
    ...
    it('should handle data with missing or invalid values', () => {
      ...
      const result = transformMultiDisplayData(mockData, null, 10, 'metadata.funding.funder');
  ...
  describe('filterSeriesArrayByDate integration', () => {
    ...
    it('should work with the actual component data flow', () => {
      ...
      const result = transformMultiDisplayData(filteredData, null, 10, 'metadata.funding.funder');
