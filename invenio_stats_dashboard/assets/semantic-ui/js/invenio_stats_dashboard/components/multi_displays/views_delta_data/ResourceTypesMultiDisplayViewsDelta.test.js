...
import { ResourceTypesMultiDisplayViewsDelta } from './ResourceTypesMultiDisplayViewsDelta';
...
describe('ResourceTypesMultiDisplayViewsDelta', () => {
  ...
  describe('Component rendering', () => {
    it('should render with default props (list view)', () => {
      render(<ResourceTypesMultiDisplayViewsDelta default_view="list" />);
    ...
    it('should render with custom title and headers', () => {
      render(<ResourceTypesMultiDisplayViewsDelta title="Custom Title" headers={["Custom Header", "Custom Count"]} default_view="list" />);
      const statsDisplay = screen.getByRole('region');
      expect(statsDisplay).toBeInTheDocument();
